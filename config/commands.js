...
var commands = exports.commands = {
	...
	groups: function(target, room, user) {
		if (!this.canBroadcast()) return;
		this.sendReplyBox('+ <b>Mews Slave</b> - They can use ! commands like !groups, and talk during moderated chat. They are also forced to obey Mews every command<br />' +
			'% <b>trachys concubine</b> - The above, and they can mute. Global % can also lock users and check for alts. They also get to be with trachy, and listen to his every drunk command<br />' +
			'@ <b>Hexs Servant</b> - The above, and they can ban users. They are the lucky ones, since they got Hex, the everlasting god of forgiveness as their master<br />' +
			'&amp; <b>Magikarp Knight</b> - The above, and they can promote to moderator and force ties. They represent Magikarp in all his power and glory<br />' +
			'~ <b>Sunkern Lord</b> - They can do anything, like change what this message says. They also get to be the gods of the server, taking the form of the mighty Sunkern<br />' +
